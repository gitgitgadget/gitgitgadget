...
export async function git(args: string[], options?: IGitExecutionOptions | undefined): Promise<string> {
...
export async function gitConfigForEach(key: string, callbackfn: (value: string) => void): Promise<void> {
